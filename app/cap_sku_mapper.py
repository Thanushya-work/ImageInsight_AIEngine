...
# IOU_DEDUP_THRESHOLD: float = 0.50    # IoU above which two boxes are duplicates
...
#     11: 10,  # Fanta 175ml Glass     → new productclassid you just inserted
...
MAX_MATCH_DIST_P2R: float  = 700.0   # pixels – P2-reuse (already-claimed slot)
MAX_MATCH_DIST_P3R: float  = 500.0   # pixels – P3-reuse
IOU_DEDUP_THRESHOLD: float = 0.75    # IoU above which two boxes are duplicates
